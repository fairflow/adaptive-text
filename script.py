...
# Create a complete working code demo for adaptive text viewer
# This will be a self-contained Python script using Streamlit
...
# Save the demo code
with open('adaptive_text_demo.py', 'w') as f:
    f.write(demo_code)

print("✓ Created: adaptive_text_demo.py")
print("\nTo run this demo:")
print("1. Install dependencies: pip install streamlit")
print("2. Run: streamlit run adaptive_text_demo.py")
print("\nThe demo includes:")
print("- Resolution slider (0-3: Summary → Expanded)")
print("- Formality slider (1-10: Casual → Formal)")
print("- Reading age slider (8-18 years)")
print("- Mock micropayment system with wallet")
print("- SQLite persistence for purchases")
print("- Download functionality for owned content")
print("- Block-level unlocking with dynamic pricing")
